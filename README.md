...
| <div style="display: flex; flex-direction:column; justify-content: center; align-items: center"> <img width="40" src="https://avatars.githubusercontent.com/u/62144965?v=4"/> <br> [Bae-JunSeok](https://github.com/Bae-JunSeok) (배준석) </div> | 정보컴퓨터공학 <br> 201724486  | 프론트엔드    | - React를 사용해 UI 개발<br> - 프론트엔드 백엔드 연결 |
